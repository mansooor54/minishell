...
// 	printf("╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝\n");
// 	printf("\n");
// 	printf("          Welcome to \033[1;33mMansoor MiniShell\033[1;36m 🦅\n\n");
// 	printf("\033[0m"); // reset color
// }

void	print_logo(void)
{
	printf("\033[1;36m"); // Cyan color for title
	printf("███╗   ███╗██╗███╗   ██╗██╗██████╗██╗  ██╗██████╗██╗    ██╗     \n");
	printf("\033[1;31m████╗ ████║██║\033[0m\033[1;32m████╗  ██║██║██╔═══╝██║  ██║██╔═══╝██║    ██║\033[0m     \n");
	printf("\033[1;31m██╔████╔██║██║\033[0m\033[1;37m██╔██╗ ██║██║██████╗███████║█████╗ ██║    ██║\033[0m     \n");
	printf("\033[1;31m██║╚██╔╝██║██║\033[0m\033[1;30m██║╚██╗██║██║╚═══██║██╔══██║██╔══╝ ██║    ██║\033[0m     \n");
	printf("\033[1;36m"); // Cyan color for title
	printf("██║ ╚═╝ ██║██║██║ ╚████║██║██████║██║  ██║██████╗██████╗██████╗\n");
	printf("╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝╚═╝╚═════╝╚═╝  ╚═╝╚═════╝╚═════╝╚═════╝\n");
	printf("         Welcome to \033[1;33mMansoor MiniShell\033[1;36mfor 42 School 🇦🇪\033[1;36m\n");
	printf("\033[0m\n"); // Reset color
}
