...
** Allocates memory for token and duplicates the value string
*/
...
** Traverses to the last token and appends the new one
*/
...
** Frees both the value string and the token structure
*/
